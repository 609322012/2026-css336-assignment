...
from cs336_basics.section2_bep_basic import BEP
from cs336_basics.section2_bep_basic import Tokenizer
...
def run_train_bpe(
    ...
    **kwargs,
    ...
    """
    # raise NotImplementedError
    return BEP(input_path,vocab_size,special_tokens,**kwargs)
